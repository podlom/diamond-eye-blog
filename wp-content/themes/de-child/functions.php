...
$generation_serial = '38.41691337897257';
...
add_action( 'wp_enqueue_scripts', function () {
	...
	wp_enqueue_style( 'Montserrat', 'https://storage.googleapis.com/yotako-fonts/CdnFonts/css/Montserrat.css' );
	wp_enqueue_script( 'custom-script', get_theme_file_uri() . '/script.js', array(), wp_get_theme( 'yotako' )->get( 'Version' ) );
	wp_enqueue_script(
		'js-alert',
...
function yotako_register_block_patterns()
{
	...
	$yotako_block_pattern_categories = apply_filters( 'yotako_block_pattern_categories', array(
		...
		'yotako-top-menu'      => array(
			'label' => esc_html__( 'Yotako Top Menu', 'yotako' ),
		),
		'yotako-bottom-menu'      => array(
			'label' => esc_html__( 'Yotako Bottom Menu', 'yotako' ),
		),
...
function add_pages()
{
	...
	$pages = array( array( "name" => "Home_page", "slug" => "Home_page", "mainPage" => true ), );
